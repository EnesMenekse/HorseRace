<template>
  <header class="flex justify-between items-center gap-3 w-full h-16 p-0 sm:p-3 bg-blue-500 text-white">
...
import Program from "./components/raceProgram/Program.vue";
...
<style scoped>
button {
  @apply shrink-0 p-2 text-sm sm:text-lg font-bold rounded-full bg-gray-300 border-2 border-black;
}
</style>
